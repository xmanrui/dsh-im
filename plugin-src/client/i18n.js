...
const EN = Object.freeze({
  ...
  '已启用服务商': 'Enabled providers',
  '未启用服务商': 'Available providers',
  '返回服务商列表': 'Back to providers',
  '未接入': 'Not connected',
  '未配置': 'Not configured',
  '个人微信扫码接入，长轮询收发消息': 'Connect a personal WeChat account by QR code and exchange messages over long polling',
  '飞书扫码或手动接入，支持多机器人与群聊': 'Connect Feishu by QR code or manually, with multiple bots and group chats',
  '钉钉 Stream 长连接，扫码授权接入': 'DingTalk Stream connection, authorized by QR code',
  '企业微信智能机器人，WebSocket 长连接': 'WeCom AI bot over a WebSocket connection',
  'QQ 官方机器人，扫码创建并绑定': 'Official QQ bot, created and bound by QR code',
  'Socket Mode 长连接，Manifest 快速配置': 'Socket Mode connection, configured with an app manifest',
  'Bot Token 接入，支持命令菜单': 'Connect with a Bot Token, with a command menu',
  'Developer Portal 创建 Bot 后邀请接入': 'Create a bot in the Developer Portal, then invite it',
  '扫码关联设备，个人号收发消息': 'Link a device by QR code and exchange messages from a personal account',
  '企业微信应用回调通道，需配置回调 URL': 'WeCom app callback channel; a callback URL is required',
  'macOS 原生 Messages，需本机权限': 'Native macOS Messages; local permissions are required',
  'IMAP/SMTP 邮箱或腾讯 Agent 邮箱': 'An IMAP/SMTP mailbox or a Tencent Agent mailbox',
  'homeserver 与凭据接入': 'Connect with a homeserver and credentials',
  'AI Office Connector 工作台接入': 'Connect an AI Office Connector workspace',
