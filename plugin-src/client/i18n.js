...
const EN = Object.freeze({
  ...
  '个机器人。': 'bots.',
  '已同步到': 'Copied to',
  '这个渠道没有其他飞书机器人，不用同步。': 'This channel has no other Feishu bots to copy to.',
  '正在同步…': 'Copying…',
  '确认同步': 'Copy to all',
  '个飞书机器人，它们各自的面板设置会被覆盖。': 'other Feishu bots, overwriting their own panel settings.',
  '将把这套面板设置写入另外': 'This copies the panel to',
  '保存并同步到其他机器人': 'Save and copy to the other bots',
  '指令面板设置': 'Command panel settings',
  '指令面板模式': 'Command panel mode',
  '面板只决定聊天输入框里打「/」时列出的指令和顺序；被移除的指令仍可手动输入，功能不受影响。同步由机器人后台完成，指令较多时需要一点时间。': 'The panel only decides which commands the "/" list in the chat input offers, and in which order. A removed command can still be typed by hand and keeps working. The bot syncs the panel in the background; many commands take a moment.',
  '跟随默认（随插件版本更新）': 'Follow the default (updated with the plugin)',
  '自定义（自己挑指令和顺序）': 'Custom (choose the commands and their order)',
  '当前没有选择任何指令，保存后「/」面板会变成空的。': 'No commands are selected; saving leaves the "/" panel empty.',
  '添加指令': 'Add command',
  '选择要加入的指令': 'Choose a command to add',
  '指令都已加入': 'Every command is already listed',
  '加入': 'Add',
  '恢复全部': 'Restore all',
  '全部移除': 'Remove all',
  '移除': 'Remove',
  ...
  '下移': 'Move down',
  '保存': 'Save',
  '已保存，面板稍后同步': 'Saved; the panel syncs shortly',
  '请选择面板要显示的指令与顺序。': 'Choose which commands the panel shows, and in what order.',
  '飞书指令面板设置暂不可用。': 'The Feishu command panel settings are unavailable right now.',
