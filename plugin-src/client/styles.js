...
.dim-panel .dim-stateDot[data-tone="error"] { background: var(--dsw-alias-state-error-primary, #d54941); box-shadow: 0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-error-primary, #d54941) 14%, transparent); }
