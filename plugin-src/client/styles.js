...
.dim-contextTooltipExample { padding: 7px 8px; border-radius: var(--dim-radius-8); background: var(--dim-module-fill); font-family: var(--dim-font-mono); white-space: pre-wrap; }
...
/* The host's hint/description role is label-tertiary, not secondary: ui-settings-plugins
   ...
   only hint-named rules still on secondary, and its own .dim-helpHint/.dim-modelHint/.dim-modelDescription
