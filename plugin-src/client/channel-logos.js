...
export function GithubMarkGlyph({ size } = {}) {
  // GitHub's own mark (Octicons "mark-github", MIT), used instead of the
  // "GitHub ↗" text chip so the page header carries one icon-sized link like
  // every other native header action.
  return h('svg', {
    ...dimensions(size),
    viewBox: '0 0 16 16',
    focusable: 'false',
