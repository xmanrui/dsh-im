...
var EN = Object.freeze({
  ...
  "\u5F00\u542F\u540E\uFF0C\u7FA4\u804A\u6216\u79C1\u804A\u91CC\u7684 /workspace\u3001\u83DC\u5355\u5207\u6362\u548C\u8DE8\u5DE5\u4F5C\u533A /session \u53EA\u5F71\u54CD\u5F53\u524D\u804A\u5929\uFF0C\u4E0D\u4F1A\u6539\u6389\u540C\u4E00\u673A\u5668\u4EBA\u7684\u5176\u4ED6\u7FA4\u3002\u5173\u95ED\u540E\u4ECD\u6574\u53F0\u673A\u5668\u4EBA\u5171\u7528\u4E00\u4E2A\u5DE5\u4F5C\u533A\u3002": "When enabled, /workspace, menu switches, and cross-workspace /session in a group or direct chat affect only that chat, not other chats of the same bot. When disabled, every chat of the bot still shares one workspace.",
  ...
  "\u5F00\u542F\u540E\uFF0C\u7FA4\u804A\u6216\u79C1\u804A\u91CC\u7684 /guidance \u53EA\u6539\u5F53\u524D\u804A\u5929\u7684\u589E\u5F3A\u63D0\u793A\u8BCD\uFF0C\u4E0D\u4F1A\u6539\u6389\u540C\u4E00\u673A\u5668\u4EBA\u7684\u5176\u4ED6\u7FA4\u3002\u8BBE\u7F6E\u9875\u4ECD\u7F16\u8F91\u6574\u53F0\u673A\u5668\u4EBA\u7684\u9ED8\u8BA4\u63D0\u793A\u8BCD\u3002\u5173\u95ED\u540E\u4ECD\u6574\u53F0\u673A\u5668\u4EBA\u5171\u7528\u7FA4\u804A/\u79C1\u804A\u5404\u4E00\u4EFD\u63D0\u793A\u8BCD\u3002": "When enabled, /guidance in a group or direct chat changes only that chat\u2019s enhancement guidance, not other chats of the same bot. The settings card still edits the bot-wide default. When disabled, every chat of the bot still shares one group guidance and one direct-chat guidance.",
...
function normalizeBot(value) {
  ...
  return {
    ...
    isolateConversationWorkspace: value.isolateConversationWorkspace === true,
    isolateConversationGuidance: value.isolateConversationGuidance === true,
...
// plugin-src/client/isolate-workspace-editor.js
var React9 = __toESM(require("react"), 1);
function IsolateWorkspaceEditor({ enabled = false, disabled = false, onSave }) {
  ...
  return h2(
    "div",
    { className: "dim-preset dim-isolateWorkspace" },
    h2(
      "label",
      ...
      saving ? h2("span", { className: "dim-presetStatus" }, "\u4FDD\u5B58\u4E2D\u2026") : h2("input", {
        type: "checkbox",
        role: "switch",
    ...
    error ? h2("p", { className: "dim-presetError" }, error) : null
  );
}

// plugin-src/client/isolate-guidance-editor.js
var React10 = __toESM(require("react"), 1);
function IsolateGuidanceEditor({ enabled = false, disabled = false, onSave }) {
  ...
  return h2(
    "div",
    { className: "dim-preset dim-isolateWorkspace dim-isolateGuidance" },
    h2(
      "label",
      { className: "dim-contextSwitchRow" },
      h2(
...
function createTokenChannelSettings(definition) {
  ...
  function AccountCard6({ account, busy, testNotice, removing, onReconnect, onWorkspaceSave, onIsolateWorkspaceSave, onIsolateGuidanceSave, onModelSave, onAgentPresetSave, onContextEnhancementSave, onAccountSettingsSave, onRequestRemove, onConfirmRemove, onCancelRemove }) {
    const state = busy === "reconnect" ? "connecting" : account.state;
    const tone = account.connected ? "success" : state === "error" ? "error" : "warning";
    const stateLabel2 = account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA";
    const summary2 = account.error?.message ?? (account.connected ? null : account.health.summary);
  ...
  const botList = model.bots.length > 0 ? h2(
    ...
    h2("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h2("li", { key: account.botId }, h2(AccountCard3, {
      ...
      onIsolateWorkspaceSave: (isolateConversationWorkspace) => botAction(
        account,
        "workspace-isolate",
        WECOM_ENDPOINTS.setIsolateConversationWorkspace,
        { botId: account.botId, isolateConversationWorkspace }
      ),
      onIsolateGuidanceSave: (isolateConversationGuidance) => botAction(
        account,
        "guidance-isolate",
        WECOM_ENDPOINTS.setIsolateConversationGuidance,
        { botId: account.botId, isolateConversationGuidance }
      ),
      onModelSave: (selectedModel) => botAction(
        account,
    ...
    model.phase === "loading" ? h2(LoadingView6) : model.phase === "error" ? h2(
      ...
      model.bots.length > 0 ? h2(AccountList2, {
        ...
        onIsolateWorkspaceSave: (account, isolateConversationWorkspace) => saveBotSetting(
          account,
          "workspace-isolate",
          WEIXIN_ENDPOINTS.setIsolateConversationWorkspace,
          { isolateConversationWorkspace }
        ),
        onIsolateGuidanceSave: (account, isolateConversationGuidance) => saveBotSetting(
          account,
          "guidance-isolate",
          WEIXIN_ENDPOINTS.setIsolateConversationGuidance,
          { isolateConversationGuidance }
        ),
        onModelSave: (account, selectedModel) => saveBotSetting(
          account,
