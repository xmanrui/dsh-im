...
var NEW_SESSION_ONLY_NOTE = "\u53EA\u5F71\u54CD\u65B0\u5EFA\u4F1A\u8BDD\uFF1B\u82E5\u5F53\u524D\u804A\u5929\u5DF2\u6709\u4F1A\u8BDD\uFF0C\u5148\u53D1\u9001 /new\uFF0C\u518D\u53D1\u9001\u666E\u901A\u6D88\u606F\u751F\u6548\u3002";
...
function AgentPresetEditor({ agentPreset = "", disabled = false, onSave }) {
  ...
  return h2(
    ...
    h2("p", { className: "dim-helpHint" }, NEW_SESSION_ONLY_NOTE),
...
function ChevronRightGlyph({ size } = {}) {
  return h3(
    ...
    h3("path", { fill: "currentColor", d: "M5.5 2.15137L5.92383 2.57617L8.65137 5.30273C8.90706 5.55843 9.13382 5.78438 9.29785 5.98828C9.46883 6.20088 9.61756 6.44405 9.66602 6.75C9.69222 6.91565 9.69222 7.08435 9.66602 7.25C9.61756 7.55595 9.46883 7.79912 9.29785 8.01172C9.13382 8.21561 8.90706 8.44157 8.65137 8.69727L5.92383 11.4238L5.5 11.8486L4.65137 11L5.07617 10.5762L7.80273 7.84863C8.07732 7.57405 8.24849 7.40124 8.3623 7.25977C8.46904 7.12709 8.47813 7.07728 8.48047 7.0625C8.48703 7.02105 8.48703 6.97895 8.48047 6.9375C8.47813 6.92272 8.46904 6.87291 8.3623 6.74023C8.24848 6.59876 8.07732 6.42595 7.80273 6.15137L5.07617 3.42383L4.65137 3L5.5 2.15137Z" })
  );
}
...
function CloseGlyph({ size } = {}) {
  return h3(
    ...
    h3("path", { fill: "currentColor", d: "M14.1168 13.197L13.197 14.1167L1.8833 2.80303L2.80309 1.88324L14.1168 13.197Z" }),
    h3("path", { fill: "currentColor", d: "M13.197 1.88326L14.1168 2.80305L2.80309 14.1168L1.8833 13.197L13.197 1.88326Z" })
  );
}
...
var ModelCatalogContext = React5.createContext(EMPTY_MODEL_CATALOG);
...
function ModelEditor({ model = null, disabled = false, onSave }) {
  const catalog = normalizeModelCatalog(React5.useContext(ModelCatalogContext));
  const id6 = React5.useId();
  const rootRef = React5.useRef(null);
  const menuRef = React5.useRef(null);
  const triggerRef = React5.useRef(null);
  const restoreFocusRef = React5.useRef(false);
  const savingRef = React5.useRef(false);
  const [pane, setPane] = React5.useState(null);
  ...
  const option = (key, label, description, selected, next) => h2(
    ...
    h2("span", { className: "dim-modelCheck", "aria-hidden": true }, selected ? h2(CheckGlyph, { size: 16 }) : null)
  );
  ...
  return h2(
    ...
    h2(
      "div",
      { className: "dim-presetHeader" },
      h2("span", { className: "dim-presetTitle" }, "\u6A21\u578B\u4E0E\u601D\u8003\u5F3A\u5EA6"),
...
function BotName({ bot, id: id6, disabled = false, onSave }) {
  ...
  const nameRef = React6.useRef(null);
  const tooltipId = React6.useId();
  const [truncated, setTruncated] = React6.useState(false);
  const [hovered, setHovered] = React6.useState(false);
  const [focused, setFocused] = React6.useState(false);
  const [dismissed, setDismissed] = React6.useState(false);
  const dismissTooltip = React6.useCallback(() => setDismissed(true), []);
  const measure = React6.useCallback(() => {
...
function CredentialBindingPanel({
  ...
  const [secret, setSecret] = React7.useState("");
...
function CollapsibleAccountSection({
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        "span",
        { className: "dim-collapsibleChevron", "aria-hidden": "true" },
        h2(ChevronRightGlyph, { size: 14 })
      )
    ),
    h2(
      "div",
      ...
      h2(
        ...
        listing ? h2(
          ...
          crumbs.map((crumb, index) => h2(
            React9.Fragment,
            { key: crumb.path },
            index > 0 ? h2("span", { className: "dim-directoryCrumbSeparator", "aria-hidden": "true" }, h2(ChevronRightGlyph, { size: 14 })) : null,
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        h2(
          "span",
          { className: "dim-helpHint dim-contextLegendHint" },
      ...
      h2("div", { className: "dim-contextFields" }, CONTEXT_ENHANCEMENT_FIELDS.map((field) => {
        ...
        return h2(
          ...
          h2(
            ...
            FIELD_HELP[field] ? h2("span", { className: "dim-helpHint dim-contextFieldHint" }, FIELD_HELP[field].text) : null,
  ...
  const content = h2("div", {
    ...
    h2(
      ...
      h2(
        ...
        h2("p", { id: descriptionId, className: "dim-helpHint" }, "\u9009\u62E9\u5728\u54EA\u4E9B\u4F1A\u8BDD\u4E2D\u542F\u7528\u3001\u63D0\u4F9B\u54EA\u4E9B\u6765\u6E90\u5B57\u6BB5\uFF0C\u4EE5\u53CA\u5982\u4F55\u4F7F\u7528\u8FD9\u4E9B\u4FE1\u606F\u3002\u4EC5\u4F7F\u7528\u5DF2\u6709\u6D88\u606F\u5143\u6570\u636E\uFF0C\u4E0D\u67E5\u8BE2\u5E73\u53F0 API\u3002")
      ),
      h2("button", {
        type: "button",
...
function ChannelListHeading({ className = "", id: id6, title, connectionLabel }) {
  return h2(
    ...
    h2(
      ...
      h2("span", { className: "dim-listConnection" }, connectionLabel)
    )
  );
}
...
.ddt-badge { min-height: 30px; display: inline-flex; align-items: center; gap: 7px; padding: 0 11px; border-radius: var(--dim-radius-full); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font-size: var(--dim-font-12); white-space: nowrap; }
...
.ddt-button { height: 28px; display: inline-flex; align-items: center; justify-content: center; gap: 4px; padding: 0 10px; border: 0.5px solid var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-14); color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: inherit; font-size: var(--dim-font-12); font-weight: 400; text-decoration: none; cursor: pointer; transition: border-color .15s ease, background .15s ease, transform .15s ease; }
.ddt-button:hover:not(:disabled) { border-color: #aeb3bb; background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.ddt-stateLabel { display: inline-flex; align-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); font-weight: 600; }
...
.ddt-statusNotice, .ddt-inlineError { display: flex; align-items: flex-start; gap: 10px; padding: 13px 15px; border: 1px solid color-mix(in srgb, var(--ddt-error) 28%, transparent); border-radius: var(--dim-radius-10); color: var(--ddt-error); background: color-mix(in srgb, var(--ddt-error) 7%, transparent); font-size: var(--dim-font-13); }
.ddt-inlineError { flex-direction: column; padding: 22px; }
.ddt-inlineError h3 { font-size: var(--dim-font-16); }
...
.ddt-errorHint { margin: 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 1.55; }
...
.ddt-health { display: inline-flex; align-items: center; gap: 7px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); white-space: nowrap; }
.ddt-accountFooter { display: flex; align-items: center; justify-content: space-between; gap: 15px; padding-top: 16px; border-top: 0.5px solid var(--dsw-alias-border-l1, #eef0f3); }
...
var Button = React14.forwardRef(function Button2({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function ConnectionErrorDiagnostic({ error }) {
  ...
  return h2(
    ...
    h2(
      ...
      h2("span", null, "\u9519\u8BEF\u7801"),
      `: ${error.code}`,
      error.referenceId ? h2(React14.Fragment, null, " \xB7 ", h2("span", null, "\u53C2\u8003\u53F7"), `: ${error.referenceId}`) : null
    )
  );
}
...
function DingtalkSettingsTab({ rpcCall }) {
  ...
  const statusRequestRef = React14.useRef(0);
  const workspaceFence = useWorkspaceSnapshotFence();
  const noticeFrameRef = React14.useRef(null);
  const focusFrameRef = React14.useRef(null);
  React14.useEffect(() => {
    mountedRef.current = true;
    return () => {
      mountedRef.current = false;
  ...
  React14.useEffect(() => installDingtalkStyles(), []);
  ...
  const discardStaleFeedback = React14.useCallback((snapshot) => {
  ...
  const focusAddButton = React14.useCallback(() => {
    if (!mountedRef.current) return;
  ...
  const setBotBusy = React14.useCallback((botId, operation) => {
    if (!mountedRef.current) return;
  ...
  const runBotAction = React14.useCallback(async ({ account, operation, endpoint, payload, success }) => {
  ...
  const reconnect = React14.useCallback((account) => runBotAction({
    account,
    operation: "reconnect",
  ...
  const saveBotSetting = React14.useCallback(async (account, operation, endpoint, payload) => {
    const snapshotVersion = workspaceFence.beginMutation();
    setBotBusy(account.botId, operation);
    try {
      const snapshot = normalizeSnapshot(await invoke(
...
var CSS3 = String.raw`
.bxf-page {
  --bxf-accent: var(--dsw-alias-state-business-primary, #4176e6);
...
.bxf-qrFallback span { display: block; color: #646a73; font-size: var(--dim-font-12); line-height: 18px; margin-top: 8px; }
...
.bxf-orbitCore { width: 50px; height: 50px; display: grid; place-items: center; border-radius: var(--dim-radius-16); color: var(--bxf-accent); background: color-mix(in srgb, var(--bxf-accent) 9%, var(--dsw-alias-bg-layer-1, #fff)); }
.bxf-connecting h3 { font-size: var(--dim-font-20); line-height: 29px; }
.bxf-connecting p { color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-13); line-height: 21px; margin-top: 7px; }
...
.bxf-responseModeSelect { min-width: 0; width: 100%; grid-column: 1 / -1; grid-row: 2; height: 32px; padding: 0 10px; border: 0.5px solid var(--dsw-alias-border-l4, rgb(0 0 0 / 16%)); border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-primary, #0f1115); background-color: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: var(--dim-font-12); cursor: pointer; transition: border-color .16s ease, box-shadow .16s ease, background-color .16s ease; }
...
.bxf-responseModeHelp { grid-column: 1 / -1; grid-row: 3; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-11); line-height: 1.45; }
.bxf-responseModePermissionAction { grid-column: 1 / -1; grid-row: 4; display: flex; justify-content: flex-start; margin-top: 2px; }
.bxf-responseModePermissionButton { min-height: 28px; padding: 3px 9px; color: var(--bxf-accent); border-color: color-mix(in srgb, var(--bxf-accent) 30%, var(--dsw-alias-border-l2, rgb(0 0 0 / 10%))); background: var(--dsw-alias-bg-layer-1, #fff); }
.bxf-responseModePermissionButton:hover:not(:disabled) { background: color-mix(in srgb, var(--bxf-accent) 7%, transparent); }
.bxf-responseModeError { grid-column: 1 / -1; grid-row: 5; color: var(--bxf-error); font-size: var(--dim-font-12); line-height: 1.4; margin: 0; }
...
.bxf-confirm {
  ...
  background: color-mix(in srgb, var(--bxf-error) 4%, var(--dsw-alias-bg-module-platform, #f5f6f7));
  padding: 17px 24px 20px;
}
.bxf-confirm:focus { outline: none; }
.bxf-confirm h4 { font-size: var(--dim-font-13); line-height: 20px; margin: 0; }
...
.bxf-skeletonLine { height: 12px; border-radius: var(--dim-radius-full); background: linear-gradient(90deg, var(--dsw-alias-bg-module-platform, #f5f6f7), color-mix(in srgb, var(--dsw-alias-label-tertiary, #81858c) 10%, transparent), var(--dsw-alias-bg-module-platform, #f5f6f7)); background-size: 220% 100%; animation: bxf-shimmer 1.5s linear infinite; }
...
.bxf-skeletonBox { width: 138px; height: 38px; border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-module-platform, #f5f6f7); margin-top: 28px; }
...
function OfficeSettingsTab({ rpcCall, initialStatus }) {
  ...
  if (phase === "loading") return h2("div", { className: "ddt-card ddt-loading dim-surfaceCard dim-loadingView", "aria-busy": "true" }, "\u6B63\u5728\u8BFB\u53D6 AI Office Connector\u2026");
  return h2(
    "section",
    { className: "dof-page dim-channelPage", "aria-label": "AI Office \u8BBE\u7F6E" },
    h2(
      "div",
      { className: "dof-hero" },
      h2(
    ...
    h2(
      ...
      h2(
        "div",
        { className: "dof-actions dim-viewActions" },
    ...
    h2(
      ...
      hooksUnavailable ? h2("p", { className: "dof-hooksEmpty" }, "\u586B\u5199\u6709\u6548\u7684 Office Base URL \u540E\uFF0C\u8FD9\u91CC\u4F1A\u663E\u793A\u56DB\u4E2A\u6D3E\u751F\u5730\u5740\u3002") : h2(
        "div",
        { className: "dof-hooks" },
        [["SSE", hooks.stream], ["Heartbeat", hooks.heartbeat], ["Job", hooks.job], ["Result", hooks.result]].map(([label, url]) => h2(
          "div",
          { className: "dof-hook", key: label },
          h2("strong", null, label),
          h2("code", { title: url ?? "" }, url ?? "\u2014")
        ))
      )
    ),
...
.dsl-avatar { background: linear-gradient(145deg, #fff, #f8fafb); border: 0.5px solid var(--dsw-alias-border-l2, rgb(0 0 0 / 10%)); }
.dsl-avatar svg { display: block; }
.dsl-setup { display: grid; gap: 18px; }
.dsl-guide { display: grid; grid-template-columns: minmax(0, 1fr) auto; align-items: start; gap: 18px; padding: 16px; border: 0.5px solid color-mix(in srgb, #4a154b 18%, var(--dsw-alias-border-l2, rgb(0 0 0 / 10%))); border-radius: var(--dim-radius-12); background: color-mix(in srgb, #4a154b 4%, var(--dsw-alias-bg-layer-1, #fff)); }
...
.dsl-tokenHint { grid-column: 1 / -1; margin: -4px 0 0; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-11); line-height: 1.55; }
@container (max-width: 680px) {
...
.dim-switchHint, .dim-callbackHint { flex: 1 1 100%; margin: 0; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 1.5; }
...
.dim-streamToggle { height: 28px; display: inline-flex; align-items: center; justify-content: center; padding: 0 10px; border: var(--dim-control-border); border-radius: var(--dim-radius-14); color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font-size: var(--dim-font-12); line-height: 18px; cursor: pointer; }
...
.dxw-eyebrow { color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); font-weight: 600; letter-spacing: .08em; text-transform: uppercase; margin-bottom: 3px; }
.dxw-heading h2 { font-size: var(--dim-font-20); line-height: 28px; font-weight: 600; }
.dxw-heading p { color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-13); line-height: 20px; margin-top: 5px; white-space: nowrap; }
...
.dxw-badge { display: inline-flex; align-items: center; gap: 7px; min-height: 30px; padding: 0 11px; border-radius: var(--dim-radius-full); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font-size: var(--dim-font-12); white-space: nowrap; }
...
.dxw-button { height: 28px; border: 0.5px solid var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-14); padding: 0 10px; display: inline-flex; align-items: center; justify-content: center; gap: 4px; color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: inherit; font-size: var(--dim-font-12); font-weight: 400; cursor: pointer; text-decoration: none; transition: border-color .15s ease, background .15s ease, transform .15s ease; }
.dxw-button:hover:not(:disabled) { border-color: #aeb3bb; background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dxw-steps { margin: 18px 0 22px; padding-left: 22px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-13); line-height: 1.9; }
.dxw-stateLabel { display: inline-flex; align-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); font-weight: 600; }
...
.dxw-input { width: 190px; height: 32px; padding: 0 10px; border: 0.5px solid var(--dsw-alias-border-l4, rgb(0 0 0 / 16%)); border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-layer-3, white); color: var(--dsw-alias-label-primary, #0f1115); font: inherit; font-size: var(--dim-font-14); line-height: 22px; letter-spacing: .16em; text-align: center; }
.dxw-statusNotice, .dxw-error { display: flex; align-items: center; gap: 10px; padding: 13px 15px; border: 1px solid color-mix(in srgb, var(--dxw-error) 28%, transparent); border-radius: var(--dim-radius-10); color: var(--dxw-error); background: color-mix(in srgb, var(--dxw-error) 7%, transparent); font-size: var(--dim-font-13); }
.dxw-error { align-items: flex-start; flex-direction: column; padding: 22px; }
.dxw-error h3 { font-size: var(--dim-font-16); }
.dxw-errorCode { font-family: ui-monospace, SFMono-Regular, monospace; font-size: var(--dim-font-11); opacity: .8; }
...
.dxw-avatar { width: 42px; height: 42px; display: grid; place-items: center; flex: none; border-radius: var(--dim-radius-12); color: white; background: var(--dxw-accent); }
...
.dxw-health { display: inline-flex; align-items: center; gap: 7px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); white-space: nowrap; }
.dxw-accountFooter { display: flex; align-items: center; justify-content: space-between; gap: 15px; padding-top: 16px; border-top: 0.5px solid var(--dsw-alias-border-l1, #eef0f3); }
...
.dxw-confirm p { color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 1.55; }
...
function ScenePolicyEditor({
  ...
  return h2(
    ...
    h2(
      "div",
      { id: legendId, className: "dim-accessLegend" },
      h2(
        "span",
        { className: "dim-accessLegendContent" },
        h2("span", null, title)
      ),
      h2("p", { className: "dim-helpHint" }, "\u539F\u6240\u6709\u8005\u6216\u626B\u7801\u63A5\u5165\u8005\u59CB\u7EC8\u53EF\u4EE5\u8BBF\u95EE\u5E76\u6267\u884C\u547D\u4EE4\uFF1B\u4EE5\u4E0B\u8BBE\u7F6E\u4EC5\u7EA6\u675F\u5176\u4ED6\u7528\u6237\u3002")
    ),
    unsupported ? h2(
      "div",
      ...
      h2(
        ...
        h2(
          ...
          h2(
            ...
            emptyAllowlist ? h2("p", { className: "dim-helpHint" }, "\u5F53\u524D\u6CA1\u6709\u767D\u540D\u5355\u7528\u6237\uFF0C\u4FDD\u5B58\u540E\u666E\u901A\u7528\u6237\u5C06\u65E0\u6CD5\u4F7F\u7528\u673A\u5668\u4EBA\u3002") : null
          ),
          h2("button", {
            type: "button",
            disabled,
...
function DeliveryTargetSettingsPage({
  ...
  if (!definition) {
    return h2(
      ...
      h2(DeliveryButton, { className: "dim-deliveryBack", onClick: onBack }, h2(ChevronLeftGlyph, { size: 14 }), "\u8FD4\u56DE\u673A\u5668\u4EBA\u5217\u8868"),
...
.dim-botNameTooltip { position: fixed; z-index: 1000; width: max-content; max-width: min(320px, calc(100vw - 16px)); white-space: normal; overflow-wrap: anywhere; pointer-events: none; animation: dim-botNameTooltip-in .15s ease; }
...
.dim-aliasEdit:hover:not(:disabled), .dim-aliasEdit:focus-visible { color: var(--dsw-alias-state-business-primary, #4176e6); background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dim-aliasOriginal { display: flex; flex-wrap: wrap; gap: 6px 14px; padding: 10px 12px; margin-bottom: 18px; border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-layer-2, #f5f6f7); overflow-wrap: anywhere; }
...
.dim-aliasDialog input { width: 100%; height: 32px; padding: 0 10px; border: var(--dim-field-border); border-radius: var(--dim-field-radius); color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: var(--dim-font-14); line-height: 22px; }
...
/* Plugin token layer. Declared on :root, NOT on .dim-page, because five
   surfaces are portalled to <body> - the directory picker, the alias dialog,
   the context dialog, the update dialog and the bot-name tooltip - and they
   therefore sit outside .dim-page. A custom property is inherited through the
   DOM, so at <body> every one of these was undefined and each declaration that
   read one was invalid and silently dropped: measured, a probe element at body
   with border: var(--dim-field-border) computed to 0px none, and
   border-radius: var(--dim-field-radius) to 0px. The portalled surfaces were
   rendering with no border and no radius at all.
...
.dim-brand { min-width: 0; width: max-content; max-width: 100%; display: flex; flex-direction: column; align-items: flex-start; gap: 1px; margin: -2px -6px; padding: 2px 6px; border-radius: var(--dim-radius-8); }
.dim-brandHeading { display: flex; align-items: center; gap: 8px; white-space: nowrap; }
.dim-brandName { color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-18); line-height: 25px; font-weight: 600; letter-spacing: 0; }
.dim-brandVersion { display: inline-flex; align-items: center; padding: 1px 8px; border: 0.5px solid var(--dsw-alias-border-l4, rgb(0 0 0 / 16%)); border-radius: var(--dim-radius-full); corner-shape: round; color: var(--dsw-alias-label-tertiary, #81858c); font: 500 11px/17px ui-monospace, SFMono-Regular, Menlo, monospace; }
.dim-title p { margin: 0; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-13); line-height: 20px; font-weight: 400; white-space: nowrap; }
.dim-titleActions { display: flex; align-items: center; justify-content: flex-end; gap: 8px; flex-wrap: wrap; }
.dim-updateButton { height: 28px; display: inline-flex; align-items: center; justify-content: center; gap: 4px; padding: 0 10px; border: var(--dim-control-border); border-radius: var(--dim-radius-14); color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: var(--dim-font-12); line-height: 18px; cursor: pointer; }
...
.dim-updateDialog h3 { margin: 22px 24px 8px; font-size: var(--dim-font-18); line-height: 25px; font-weight: 600; }
.dim-updateDescription { margin: 0 24px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-13); line-height: 20px; }
.dim-updateBody { padding: 18px 24px 20px; }
.dim-updateVersions { display: grid; grid-template-columns: max-content minmax(0, 1fr); gap: 8px 18px; margin: 0 0 18px; font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-updateStatus { padding: 12px 14px; border: 0.5px solid var(--dsw-alias-border-l1, #eef0f3); border-radius: var(--dim-radius-10); background: var(--dsw-alias-bg-layer-1, #f7f8fa); font-size: var(--dim-font-13); line-height: 20px; }
.dim-updateStatus strong { font-weight: 600; }
.dim-updateStatus p { margin: 6px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 19px; overflow-wrap: anywhere; }
.dim-updateStatusError { border-color: color-mix(in srgb, var(--dsw-alias-state-danger-primary, #d92d20) 25%, var(--dsw-alias-border-l2, rgb(0 0 0 / 10%))); }
.dim-updateHint, .dim-updateError { margin: 12px 0 0; font-size: var(--dim-font-12); line-height: 19px; overflow-wrap: anywhere; }
...
.dim-updateManualHeading { margin: 0; font-size: var(--dim-font-13); line-height: 20px; font-weight: 600; }
.dim-updateManualHint { margin: 8px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 19px; }
.dim-updateCommandRow { display: flex; align-items: center; gap: 8px; margin-top: 10px; padding: 10px 12px; border: 0.5px solid var(--dsw-alias-border-l2, rgb(0 0 0 / 10%)); border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-layer-1, #f7f8fa); }
.dim-updateCommand { display: block; flex: 1; width: 100%; min-width: 0; padding: 0; resize: none; border: 0; color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: 12px/19px ui-monospace, SFMono-Regular, Menlo, monospace; overflow-wrap: anywhere; }
...
.dim-updateCopy:hover:not(:disabled) { color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dim-githubTooltip { position: absolute; top: calc(100% + 8px); right: 0; z-index: 20; width: max-content; max-width: min(220px, 80vw); white-space: nowrap; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-generalSettingsTooltip { position: absolute; top: calc(100% + 8px); right: 0; z-index: 20; width: max-content; white-space: nowrap; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-channel { max-width: 100%; min-height: 28px; display: inline-flex; align-items: center; gap: 6px; padding: 0 10px 0 4px; border: 0; border-radius: var(--dim-radius-14); color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; text-align: left; cursor: pointer; transition: background .16s ease, color .16s ease; }
...
.dim-channelCopy strong { overflow: hidden; color: inherit; font-size: var(--dim-font-13); line-height: 20px; font-weight: 500; text-overflow: ellipsis; white-space: nowrap; }
.dim-channelNote { flex: none; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-11); line-height: 16px; font-weight: 400; white-space: nowrap; }
...
.dim-loopbackRecoveryCopy strong { display: block; font-size: var(--dim-font-14); line-height: 20px; font-weight: 600; }
.dim-loopbackRecoveryCopy p { margin: 3px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-panel .dim-credentialButton { flex: none; height: 28px; display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 0 10px; border: var(--dim-control-border); border-radius: var(--dim-radius-14); color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: inherit; font-size: var(--dim-font-12); line-height: 18px; white-space: nowrap; cursor: pointer; }
...
.dim-panel .bxf-headingTools .dim-onlineBadge, .dim-panel .dxw-tools .dim-onlineBadge, .dim-panel .ddt-tools .dim-onlineBadge { height: 24px; display: inline-flex; align-items: center; justify-self: end; gap: 4px; padding: 0 8px; border: none; border-radius: var(--dim-radius-12); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-layer-2, #fff); font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: 18px; white-space: nowrap; }
.dim-panel .dim-channelPage { min-width: 0; width: 100%; max-width: none; display: flex; flex-direction: column; gap: 12px; padding: 0 0 24px; color: var(--dsw-alias-label-primary, #0f1115); box-sizing: border-box; }
...
.dim-panel .dim-credentialTitle { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-16); line-height: 1.35; font-weight: 600; }
...
.dim-panel .dim-credentialField { min-width: 0; display: grid; gap: 6px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
...
.dim-panel .dim-listConnection { color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 18px; }
.dim-panel .dim-listHeading h3 { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 400; }
...
.dim-panel .dim-channelTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: max-content; max-width: min(280px, calc(100vw - 48px)); display: flex; align-items: baseline; gap: 5px; white-space: normal; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
.dim-panel .dim-channelTooltip strong { color: var(--dsw-alias-label-primary, #0f1115); font-weight: 600; white-space: nowrap; }
...
.dim-panel .dim-loadingView h3 { margin: 0 0 7px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-16); line-height: normal; font-weight: 600; }
...
.dim-panel .dim-emptyCopy h3 { margin: 8px 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-18); line-height: 1.35; font-weight: 600; }
...
.dim-panel .dim-stateLabel { display: inline-flex; align-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: normal; font-weight: 600; }
...
.dim-panel .dim-qrFallback { position: relative; z-index: 1; display: grid; place-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-14); line-height: 22px; text-align: center; }
...
.dim-panel .dim-countdownTop strong { color: var(--dsw-alias-label-primary, #0f1115); font-weight: 600; }
...
.dim-panel .dim-qrCopy h3 { margin: 9px 0 8px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-18); line-height: 1.35; font-weight: 600; }
...
.dim-panel .dim-inlineError h3 { margin: 0; color: inherit; font-size: var(--dim-font-16); line-height: 1.35; font-weight: 600; }
.dim-panel .dim-inlineError p { margin: 7px 0 0; color: inherit; line-height: 1.6; }
.dim-panel .dim-confirm { padding: 18px 24px; border-top: 0.5px solid var(--dsw-alias-border-l1, #eef0f3); background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dim-panel .dim-presetHeader { position: relative; flex: 1; min-width: 0; display: flex; align-items: center; gap: 8px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 400; }
...
.dim-panel .dim-presetTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: min(320px, 100%); overflow-wrap: anywhere; white-space: normal; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-modelRow { display: flex; align-items: center; gap: 8px; width: 100%; min-height: 36px; padding: 0; border: 0; background: transparent; color: var(--dsw-alias-label-primary, #0f1115); font: inherit; font-size: var(--dim-font-14); line-height: 22px; text-align: left; cursor: pointer; }
.dim-modelRowLabel { flex: 1; min-width: 0; }
/* Native selector pill (LanguageRow .selector): h36 r18, module fill, gap 12. */
.dim-modelSelector { flex: none; max-width: 60%; display: inline-flex; align-items: center; gap: 12px; height: 36px; padding: 0 14px; border-radius: var(--dim-radius-18); background: var(--dim-module-fill); }
...
.dim-modelOption { display: flex; align-items: center; gap: 8px; width: 100%; min-height: 40px; padding: 8px 10px; border: none; border-radius: var(--dim-radius-10); background: transparent; color: inherit; text-align: left; font: inherit; font-size: var(--dim-font-14); line-height: 22px; cursor: pointer; }
.dim-modelOptionCopy { display: flex; flex: 1; min-width: 0; flex-direction: column; gap: 2px; }
.dim-modelOptionName { font-size: var(--dim-font-14); line-height: 20px; font-weight: 500; overflow-wrap: anywhere; }
.dim-modelDescription { color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 18px; overflow-wrap: anywhere; }
...
.dim-panel .dim-presetError { margin: 6px 0 0; color: var(--dsw-alias-state-error-primary, #ec1313); font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-contextTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: min(330px, calc(100vw - 72px)); display: grid; gap: 5px; overflow-wrap: anywhere; white-space: normal; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
.dim-contextTooltip strong { font-weight: 600; }
.dim-contextTooltipExample { padding: 7px 8px; border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font-family: ui-monospace, SFMono-Regular, Menlo, monospace; white-space: pre-wrap; }
...
.dim-contextFooter button:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dim-directoryPickerBackdrop { position: fixed; inset: 0; z-index: 1000; display: grid; place-items: center; padding: 24px; background: var(--dsw-alias-bg-mask-1, rgb(0 0 0 / 24%)); backdrop-filter: var(--dsw-mask-blur, blur(2px)); }
...
.dim-directoryPickerHeader h3 { margin: 0 0 14px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-20); line-height: 1.35; font-weight: 600; }
.dim-directoryPickerHeader > p { margin: 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-13); }
.dim-directoryCrumbs { min-width: 0; display: flex; align-items: center; flex-wrap: wrap; gap: 4px; color: var(--dsw-alias-label-tertiary, #81858c); }
.dim-directoryCrumbs button { max-width: 210px; overflow: hidden; padding: 3px 5px; border: 0; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: var(--dim-font-12); line-height: 18px; text-overflow: ellipsis; white-space: nowrap; cursor: pointer; }
.dim-directoryCrumbs button:hover:not(:disabled) { color: var(--dim-blue); background: var(--dim-blue-soft); }
.dim-directoryCrumbs button[aria-current="page"] { color: var(--dsw-alias-label-primary, #0f1115); font-weight: 600; }
...
.dim-directoryPathMeta label { flex: none; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); font-weight: 600; }
...
.dim-directoryList button { width: 100%; min-height: 46px; display: grid; grid-template-columns: 24px minmax(0, 1fr) 18px; align-items: center; gap: 10px; padding: 7px 11px; border: 0; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: inherit; text-align: left; cursor: pointer; }
.dim-directoryList button:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
...
.dim-directoryName { min-width: 0; overflow: hidden; font-size: var(--dim-font-14); line-height: 20px; text-overflow: ellipsis; white-space: nowrap; }
...
.dim-directoryPickerState p { margin: 0; font-size: var(--dim-font-13); line-height: 1.6; }
...
.dim-directoryPickerError button { flex: none; padding: 4px 8px; border: 0; border-radius: var(--dim-radius-8); color: inherit; background: transparent; font: inherit; font-weight: 600; cursor: pointer; }
.dim-directoryPickerTruncated { margin: 10px 4px 0; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 1.5; }
...
.dim-directoryHidden { display: inline-flex; align-items: center; gap: 7px; padding: 2px 0; border: 0; color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: var(--dim-font-12); white-space: nowrap; cursor: pointer; }
...
.dim-panel .dim-cardSummary { min-width: 0; color: var(--dsw-alias-label-secondary, #646a73); font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: normal; overflow-wrap: anywhere; white-space: normal; }
...
.dim-panel .dim-cardFeedback { width: 100%; padding: 8px 10px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: 18px; overflow-wrap: anywhere; white-space: normal; }
...
.dim-collapsibleChevron { flex: 0 0 auto; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; color: var(--dsw-alias-label-tertiary, #81858c); transition: transform .22s cubic-bezier(.4, 0, .2, 1); transform-origin: 50% 50%; }
...
.dim-panel .dim-botName h3 { overflow: hidden; margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-15); font-weight: 600; line-height: normal; text-overflow: ellipsis; white-space: nowrap; }
...
.dim-panel .dim-botCard .dim-botHealth { flex: none; min-height: 0; display: inline-flex; align-items: center; gap: 7px; padding: 0; border: 0; border-radius: 0; color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: normal; white-space: nowrap; }
.dim-panel .dim-lastChecked { max-width: 100%; overflow: hidden; text-overflow: ellipsis; display: inline-flex; align-items: baseline; gap: 4px; color: var(--dsw-alias-label-tertiary, #81858c); font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: 18px; white-space: nowrap; }
...
.dim-botSettingsButton:hover { color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-interactive-bg-hover, rgb(38 49 72 / 6%)); }
.dim-botSettingsButton:focus-visible { outline: none; box-shadow: var(--dim-focus-shadow); outline-offset: 2px; }
.dim-botSettingsTooltip { position: absolute; top: calc(100% + 6px); right: 0; z-index: 30; width: max-content; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-feishuGroupControlHeader h3 { min-width: 0; margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-13); line-height: 20px; font-weight: 500; }
...
.dim-feishuGroupHelp { margin: -2px 0 0; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 19px; }
...
.dim-feishuGroupError, .dim-feishuGroupRefreshError { margin: 0; padding: 9px 11px; border-radius: var(--dim-radius-8); font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-feishuGroupAuthorizationState h3, .dim-feishuGroupAuthorizationError h3, .dim-feishuGroupAuthorizationCopy h3 { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-16); line-height: 24px; font-weight: 600; }
.dim-feishuGroupAuthorizationState p, .dim-feishuGroupAuthorizationError p, .dim-feishuGroupAuthorizationCopy > p { margin: 5px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 19px; }
...
.dim-feishuGroupAuthorizationError code { display: inline-block; margin-top: 6px; color: var(--dsw-alias-label-tertiary, #81858c); font: 11px/17px ui-monospace, SFMono-Regular, Menlo, monospace; }
...
.dim-feishuGroupQrFallback { width: 100%; height: 100%; display: grid; place-content: center; justify-items: center; gap: 7px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-state-business-primary, #4176e6); background: #f7f9ff; text-align: center; }
.dim-feishuGroupQrFallback span { color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-11); line-height: 17px; }
.dim-feishuGroupQrExpired { position: absolute; inset: 10px; display: grid; place-content: center; gap: 2px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-primary, #0f1115); background: rgb(255 255 255 / 94%); backdrop-filter: blur(3px); text-align: center; }
...
.dim-feishuGroupCountdown { width: 176px; display: grid; grid-template-columns: minmax(0, 1fr) max-content; gap: 5px 10px; margin-top: 9px; color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-11); line-height: 17px; font-variant-numeric: tabular-nums; }
...
.dim-feishuGroupAuthorizationEyebrow { display: block; margin-bottom: 7px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-11); line-height: 17px; font-weight: 600; }
.dim-feishuGroupAuthorizationCopy ol { display: grid; gap: 6px; margin: 13px 0 0; padding-left: 18px; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-11); line-height: 18px; }
...
.dim-deliveryDocsLink { min-height: 30px; flex: none; display: inline-flex; align-items: center; gap: 4px; padding: 5px 8px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-state-business-primary, #4176e6); font-size: var(--dim-font-12); line-height: 18px; text-decoration: none; white-space: nowrap; }
...
.dim-deliveryBotName, .dim-deliverySectionHeading h3 { min-width: 0; overflow: hidden; margin: 0; font-size: var(--dim-font-15); line-height: 22px; font-weight: 600; text-overflow: ellipsis; white-space: nowrap; }
.dim-deliveryIdentity > div:first-child p, .dim-deliverySectionHeading p { margin: 2px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 18px; }
.dim-deliveryBotId { min-width: 0; display: grid; grid-template-columns: max-content minmax(0, 1fr) max-content; align-items: center; gap: 10px; margin-top: 12px; padding: 10px 12px; border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-module-platform, #f5f6f7); }
...
.dim-deliveryState { margin-top: 14px; padding: 24px 16px; border: 1px dashed var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-10); color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 19px; text-align: center; }
...
.dim-targetRow { min-width: 0; display: grid; grid-template-columns: minmax(0, 1fr) max-content; gap: 8px 14px; padding: 13px; border: 0; border-radius: var(--dim-radius-12); background: var(--dsw-alias-bg-module-platform, #f5f6f7); }
.dim-targetSummary { min-width: 0; }
.dim-targetTitle { min-width: 0; display: flex; align-items: center; gap: 7px; }
.dim-targetTitle strong { overflow: hidden; font-size: var(--dim-font-13); line-height: 20px; font-weight: 600; text-overflow: ellipsis; white-space: nowrap; }
...
.dim-targetSessionSyncCopy strong { color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-12); line-height: 18px; font-weight: 600; }
.dim-targetSessionSyncCopy small { color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-11); line-height: 17px; }
...
.dim-targetFeedback { grid-column: 1 / -1; margin: 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-11); line-height: 17px; }
...
.dim-targetDeleteConfirm p { margin: 0 0 8px; font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-targetSuggestionHeading h3 { margin: 0; font-size: var(--dim-font-14); line-height: 21px; }
...
.dim-targetSuggestionState { margin-top: 12px; padding: 18px 12px; border: 1px dashed var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 18px; text-align: center; }
.dim-targetSuggestionState p { margin: 4px 0; }
.dim-targetSuggestionState strong { color: var(--dsw-alias-label-primary, #0f1115); }
.dim-targetSuggestionField { min-width: 0; display: grid; gap: 6px; margin-top: 12px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
.dim-targetSuggestionField select { width: 100%; min-width: 0; height: 32px; padding: 0 10px; border: var(--dim-field-border); border-radius: var(--dim-field-radius); color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: var(--dim-font-14); line-height: 22px; cursor: pointer; }
...
.dim-targetFormHeading h3 { margin: 0; font-size: var(--dim-font-14); line-height: 21px; }
...
.dim-targetField { min-width: 0; display: grid; align-content: start; gap: 6px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
.dim-targetField input, .dim-targetField select { width: 100%; min-width: 0; height: 32px; padding: 0 10px; border: var(--dim-field-border); border-radius: var(--dim-field-radius); color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: var(--dim-font-14); line-height: 22px; }
...
.dim-targetFormError { margin: 10px 0 0; font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-accessLegend { margin: 0 0 4px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
...
.dim-accessField { min-width: 0; display: grid; align-content: start; gap: 6px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
.dim-accessField input, .dim-accessField select { width: 100%; min-width: 0; height: 32px; padding: 0 10px; border: var(--dim-field-border); border-radius: var(--dim-field-radius); color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: var(--dim-font-14); line-height: 22px; }
...
.dim-accessUsersHeading strong { color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-13); line-height: 20px; font-weight: 600; }
...
.dim-accessAddUser { width: 32px; height: 32px; min-height: 32px; flex: 0 0 32px; padding: 0; font-size: var(--dim-font-20); line-height: 1; }
.dim-accessUsersEmpty { margin-top: 10px; padding: 15px 12px; border: 1px dashed var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-tertiary, #81858c); font-size: var(--dim-font-12); line-height: 18px; text-align: center; }
.dim-accessUserList { display: grid; gap: 9px; margin: 10px 0 0; padding: 0; list-style: none; }
.dim-accessUserRow { min-width: 0; display: grid; grid-template-columns: minmax(0, 1fr) minmax(145px, 180px) max-content; align-items: end; gap: 10px; padding: 11px; border: 0; border-radius: var(--dim-radius-12); background: var(--dsw-alias-bg-module-platform, #f5f6f7); }
...
.dim-accessUnsupported strong { color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-13); line-height: 20px; }
.dim-accessUnsupported p { margin: 4px 0 0; font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-accessFeedback { margin: 0; padding: 10px 12px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-generalSettingsHeader h2 { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-18); line-height: 25px; font-weight: 600; }
...
.dim-globalHead h3 { min-width: 0; overflow: hidden; margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-15); line-height: 22px; font-weight: 600; text-overflow: ellipsis; white-space: nowrap; }
.dim-globalTtlHelp { position: relative; display: inline-flex; flex: none; }
.dim-globalTtlTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: max-content; max-width: min(280px, calc(100vw - 48px)); opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-globalTtlHints code { flex: none; min-width: 44px; padding: 0 6px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-label-primary, #0f1115); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font: 11px/16px ui-monospace, SFMono-Regular, Menlo, monospace; text-align: center; }
...
.dim-globalSweepConfirm { position: absolute; top: calc(100% + 8px); right: 0; z-index: 35; width: 218px; padding: 11px 12px; border: 0.5px solid var(--dsw-alias-border-l2, rgb(0 0 0 / 10%)); border-radius: var(--dim-radius-8); background: var(--dsw-alias-bg-layer-3, #fff); box-shadow: 0 12px 30px rgb(31 35 41 / 18%); }
.dim-globalSweepConfirm p { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-12); line-height: 18px; }
...
@container (max-width: 680px) {
  ...
  .dim-panel .bxf-headingTools .dim-scanButton, .dim-panel .dxw-tools .dim-scanButton, .dim-panel .ddt-tools .dim-scanButton, .dim-panel .dim-credentialButton { gap: 5px; padding-inline: 8px; font-size: var(--dim-font-12); }
...
function IMSettingsTab({
  ...
  const railTabRefs = React32.useRef([]);
  ...
  const onRailKeyDown = (event) => {
    ...
    const from = Math.max(0, CHANNELS.findIndex((channel5) => channel5.id === selected));
    const next = key === "Home" ? 0 : key === "End" ? count - 1 : (from + (key === "ArrowRight" ? 1 : -1) + count) % count;
    event.preventDefault();
    ...
    h2(
      ...
      h2(
        ...
        h2(
          ...
          CHANNELS.map((channel5, index) => h2(
            "button",
            {
              ref: (node) => {
                railTabRefs.current[index] = node;
              },
              key: channel5.id,
              type: "button",
              role: "tab",
              ...
              tabIndex: !globalSettingsSelected && channel5.id === active.id || globalSettingsSelected && channel5.id === CHANNELS[0].id ? 0 : -1,
