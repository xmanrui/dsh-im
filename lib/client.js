...
.dxw-badge { display: inline-flex; align-items: center; gap: var(--dim-gap-7); min-height: 30px; padding: 0 11px; border-radius: var(--dim-radius-full); color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-module-platform, #f5f6f7); font-size: var(--dim-font-12); white-space: nowrap; }
...
.dxw-button { height: 28px; border: 0.5px solid var(--dsw-alias-border-l3, #dfe1e5); border-radius: var(--dim-radius-14); padding: 0 10px; display: inline-flex; align-items: center; justify-content: center; gap: var(--dim-gap-4); color: var(--dsw-alias-label-primary, #0f1115); background: transparent; font: inherit; font-size: var(--dim-font-12); font-weight: 400; cursor: pointer; text-decoration: none; transition: border-color .15s ease, background .15s ease, transform .15s ease; }
.dxw-button:hover:not(:disabled) { border-color: #aeb3bb; background: var(--dim-hover); }
...
.dxw-stateLabel { display: inline-flex; align-items: center; gap: var(--dim-gap-8); color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); font-weight: 600; }
...
.dxw-errorCode { font-family: ui-monospace, SFMono-Regular, monospace; font-size: var(--dim-font-11); opacity: .8; overflow-wrap: anywhere; }
...
.dim-updateVersions { display: grid; grid-template-columns: max-content minmax(0, 1fr); gap: var(--dim-gap-8) 18px; margin: 0 0 18px; font-size: var(--dim-font-12); line-height: 18px; }
...
.dim-panel .dim-stateLabel { display: inline-flex; align-items: center; gap: var(--dim-gap-8); color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: normal; font-weight: 600; }
...
.dim-panel .dim-inlineError h3 { margin: 0; color: inherit; font-size: var(--dim-font-16); line-height: 1.35; font-weight: 600; overflow-wrap: anywhere; }
...
.dim-modelRow { display: flex; align-items: center; gap: var(--dim-gap-8); width: 100%; min-height: 36px; padding: 0; border: 0; background: transparent; color: var(--dsw-alias-label-primary, #0f1115); font: inherit; font-size: var(--dim-font-14); line-height: 22px; text-align: left; cursor: pointer; }
...
.dim-modelOption { display: flex; align-items: center; gap: var(--dim-gap-8); width: 100%; min-height: 40px; padding: 8px 10px; border: none; border-radius: var(--dim-radius-10); background: transparent; color: inherit; text-align: left; font: inherit; font-size: var(--dim-font-14); line-height: 22px; cursor: pointer; }
...
.dim-panel .dim-botCard .dim-botHealth { flex: none; min-height: 0; display: inline-flex; align-items: center; gap: var(--dim-gap-7); padding: 0; border: 0; border-radius: 0; color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: normal; white-space: nowrap; }
.dim-panel .dim-lastChecked { max-width: 100%; overflow: hidden; text-overflow: ellipsis; display: inline-flex; align-items: baseline; gap: var(--dim-gap-4); color: var(--dsw-alias-label-tertiary, #81858c); font: inherit; font-size: var(--dim-font-12); font-weight: 400; line-height: 18px; white-space: nowrap; }
...
.dim-feishuGroupAuthorizationState h3, .dim-feishuGroupAuthorizationError h3, .dim-feishuGroupAuthorizationCopy h3 { margin: 0; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-16); line-height: 24px; font-weight: 600; overflow-wrap: anywhere; }
.dim-feishuGroupAuthorizationState p, .dim-feishuGroupAuthorizationError p, .dim-feishuGroupAuthorizationCopy > p { margin: 5px 0 0; color: var(--dsw-alias-label-secondary, #646a73); font-size: var(--dim-font-12); line-height: 19px; overflow-wrap: anywhere; }
...
.dim-feishuGroupAuthorizationError code { display: inline-block; margin-top: 6px; color: var(--dsw-alias-label-tertiary, #81858c); font: 11px/17px ui-monospace, SFMono-Regular, Menlo, monospace; overflow-wrap: anywhere; }
...
.dim-deliveryDocsLink { min-height: 30px; flex: none; display: inline-flex; align-items: center; gap: var(--dim-gap-4); padding: 5px 8px; border-radius: var(--dim-radius-8); color: var(--dsw-alias-state-business-primary, #4176e6); font-size: var(--dim-font-12); line-height: 18px; text-decoration: none; white-space: nowrap; }
...
.dim-targetSuggestionField { min-width: 0; display: grid; gap: var(--dim-gap-6); margin-top: 12px; color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
...
.dim-targetField { min-width: 0; display: grid; align-content: start; gap: var(--dim-gap-6); color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
...
.dim-accessField { min-width: 0; display: grid; align-content: start; gap: var(--dim-gap-6); color: var(--dsw-alias-label-primary, #0f1115); font-size: var(--dim-font-14); line-height: 22px; font-weight: 500; }
